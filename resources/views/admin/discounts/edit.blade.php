...
<div class="container my-4" style="max-width: 1200px !important;">
    <h1 class="h4 font-weight-bold mb-4 text-dark">Chỉnh sửa mã giảm giá</h1>
                ...
                <div class="card border mb-3 shadow-sm" style="border-radius: 6px;">
                    <div class="card-body p-4">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="name" id="input_name" class="form-control" value="{{ old('name', $discount->name) }}" required placeholder="VD: Giảm giá mùa hè, Tri ân khách hàng" style="font-size: 14px;">
                        </div>

                        <div class="form-group mb-3">
                            <label class="form-label font-weight-bold text-dark mb-1" style="font-size: 14px;">Mã Voucher (Code) *</label>
                            <input type="text" name="code" id="input_code" class="form-control" value="{{ old('code', $discount->code) }}" required placeholder="VD: SALE20, FREE100K" style="font-size: 14px;">
                        </div>

                        <div class="form-group mb-3">
                            <label class="form-label font-weight-bold text-dark mb-1" style="font-size: 14px;">Mô tả</label>
                            <textarea name="description" id="input_desc" class="form-control" rows="2" placeholder="Mô tả chương trình..." style="font-size: 14px;">{{ old('description', $discount->description) }}</textarea>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-6">
                                ...
                                <input type="number" name="discount_value" id="input_value" class="form-control" value="{{ old('discount_value', $discount->discount_value) }}" required step="0.01" min="0" placeholder="VD: 10 hoặc 50000" style="font-size: 14px;">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-6">
                                ...
                                <input type="number" name="min_purchase_amount" id="input_min" class="form-control" value="{{ old('min_purchase_amount', $discount->min_purchase_amount ?? 0) }}" min="0" placeholder="0" style="font-size: 14px;">
                            ...
                            <div class="col-6">
                                ...
                                <input type="number" name="max_discount_amount" class="form-control" value="{{ old('max_discount_amount', $discount->max_discount_amount) }}" min="0" placeholder="VD: 50000" style="font-size: 14px;">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="row">
                            <div class="col-6">
                                ...
                                <input type="number" name="max_uses" class="form-control" value="{{ old('max_uses', $discount->max_uses) }}" min="1" placeholder="Không giới hạn" style="font-size: 14px;">
                            </div>
                            <div class="col-6">
                                <label class="form-label font-weight-bold text-dark mb-1" style="font-size: 14px;">Giới hạn mỗi người dùng</label>
                                <input type="number" name="user_max_uses" class="form-control" value="{{ old('user_max_uses', $discount->user_max_uses ?? 1) }}" min="1" placeholder="1" style="font-size: 14px;">
                ...
                <div class="card border mb-3 shadow-sm" style="border-radius: 6px;">
                    <div class="card-body p-4">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="datetime-local" name="starts_at" class="form-control" value="{{ old('starts_at', $discount->starts_at ? $discount->starts_at->format('Y-m-d\TH:i') : '') }}" style="font-size: 14px;">
                        ...
                        <div class="form-group mb-0">
                            ...
                            <input type="datetime-local" name="expires_at" class="form-control" value="{{ old('expires_at', $discount->expires_at ? $discount->expires_at->format('Y-m-d\TH:i') : '') }}" style="font-size: 14px;">
                ...
                <div class="card border mb-3 shadow-sm" style="border-radius: 6px;">
                    <div class="card-body p-4">
                        ...
                        <div class="form-check mb-4">
                            ...
                            <input class="form-check-input" type="checkbox" name="is_public" id="is_public" value="1" @checked(old('is_public', $discount->is_public))>
                        ...
                        <div class="d-flex justify-content-between pt-3 border-top">
                            ...
                            <button type="submit" class="btn btn-primary px-3" style="font-size: 14px;">Lưu thay đổi</button>
                        </div>
                    </div>
                </div>
